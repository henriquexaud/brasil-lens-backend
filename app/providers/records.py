...
provider produz para atravessar a fronteira com o
domínio. A partir daqui ninguém sabe se o dado veio do IBGE, do INMET ou de um CSV.
Adicionar uma fonte nova significa produzir estes mesmos
